...
@echo off
cls
echo Requires a working command.com that doesn't crash when the set command is used
echo Tested and designed for FreeDOS FreeCom COMMAND.COM
...
REM SET BLOCKWHITE==CALL .\depends\cecho  {white on white}W{default}{
REM SET BLOCKBLACK==CALL .\depends\cecho  {black on black}B{default}{
REM SET BLOCKRED==CALL .\depends\cecho  {red on red}R{default}{
REM SET BLOCKGREEN==CALL .\depends\cecho  {green on green}G{default}{
REM SET BLOCKYELLOW==CALL .\depends\cecho  {yellow on yellow}Y{default}{
REM SET BLOCKBLUE==CALL .\depends\cecho  {blue on blue}B{default}{
REM SET BLOCKNAVY==CALL .\depends\cecho  {navy on navy}N{default}{
REM SET BLOCKTEAL==CALL .\depends\cecho  {teal on teal}T{default}{
REM SET BLOCKMAROON==CALL .\depends\cecho  {maroon on maroon}M{default}{
REM SET BLOCKPURPLE==CALL .\depends\cecho  {purple on purple}P{default}{
REM SET BLOCKOLIVE==CALL .\depends\cecho  {olive on olive}O{default}{
REM SET BLOCKSILVER==CALL .\depends\cecho  {silver on silver}S{default}{
REM SET BLOCKGRAY==CALL .\depends\cecho  {gray on gray}G{default}{
REM SET BLOCKLIME==CALL .\depends\cecho  {lime on lime}L{default}{
REM SET BLOCKAQUA==CALL .\depends\cecho  {aqua on aqua}A{default}{
REM SET BLOCKFUCHISA==CALL .\depends\cecho  {fuchisa on fuchisa}F{default}{
